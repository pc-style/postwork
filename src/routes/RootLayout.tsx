...
function ExperimentControl({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-50 flex justify-center px-4">
      <div className="pointer-events-auto flex items-center gap-2 rounded-full border border-accent/40 bg-surface/95 py-1.5 pr-3 pl-1.5 font-mono text-xs ui-popover backdrop-blur">
        <Link
